                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        if(dataSnapshot.child(edtPhone.getText().toString()).exists()) {
                            ...
                            if (user.getPassword().equals(edtPassword.getText().toString())) {
                                Toast.makeText(SignIn.this, "Chào mừng bạn đến với nhà hàng chúng tôi ...!", Toast.LENGTH_SHORT).show();
                            ...
                            progressDialog.dismiss();
                            Toast.makeText(SignIn.this, "Tài Khoản này không tồn tại .Mời bạn đăng ký.",Toast.LENGTH_SHORT).show();
                        }
                    }
